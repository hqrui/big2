...
class FiveCardPlayTest {
    ...
    void setUp() {
        try {
            ...
            stra5 = new FiveCardPlay(new Card[]{
                    Card.fromAbbrev("AD"), Card.fromAbbrev("2D"), Card.fromAbbrev("3H"),
                    Card.fromAbbrev("4S"), Card.fromAbbrev("5C")
            });
            // 2, 3, 4, 5, 6 (Mixed suits) -> Raw sort: 2, 3, 4, 5, 6. Top card: 6.
            str26 = new FiveCardPlay(new Card[]{
                    Card.fromAbbrev("2C"), Card.fromAbbrev("3D"), Card.fromAbbrev("4H"),
                    Card.fromAbbrev("5S"), Card.fromAbbrev("6C")
            });
            // T, J, Q, K, A (Mixed suits) -> Raw sort: A(1), T(10), J, Q, K. Top card: K.
            strta = new FiveCardPlay(new Card[]{
                    Card.fromAbbrev("TC"), Card.fromAbbrev("JD"), Card.fromAbbrev("QH"),
                    Card.fromAbbrev("KS"), Card.fromAbbrev("AC")
            });

            // Flushes
            // J high flush
            flucj = new FiveCardPlay(new Card[]{
                    Card.fromAbbrev("3C"), Card.fromAbbrev("5C"), Card.fromAbbrev("7C"),
                    Card.fromAbbrev("9C"), Card.fromAbbrev("JC")
            });
            // A high flush
            fluca = new FiveCardPlay(new Card[]{
                    Card.fromAbbrev("3S"), Card.fromAbbrev("5S"), Card.fromAbbrev("7S"),
                    Card.fromAbbrev("9S"), Card.fromAbbrev("AS")
            });

            // Full Houses
            // 33322 (Triplet 3)
            fh32 = new FiveCardPlay(new Card[]{
                    Card.fromAbbrev("3D"), Card.fromAbbrev("3C"), Card.fromAbbrev("3S"),
                    Card.fromAbbrev("2D"), Card.fromAbbrev("2H")
            });
            // 44455 (Triplet 4)
            fh45 = new FiveCardPlay(new Card[]{
                    Card.fromAbbrev("4D"), Card.fromAbbrev("4C"), Card.fromAbbrev("4S"),
                    Card.fromAbbrev("5D"), Card.fromAbbrev("5H")
            });

            // Quads
            // 77773 (Quad 7)
            q7 = new FiveCardPlay(new Card[]{
                    Card.fromAbbrev("7D"), Card.fromAbbrev("7C"), Card.fromAbbrev("7H"),
                    Card.fromAbbrev("7S"), Card.fromAbbrev("3D")
            });

            // Straight Flush
            // 3, 4, 5, 6, 7 (All Diamonds)
            strfl = new FiveCardPlay(new Card[]{
                    Card.fromAbbrev("3D"), Card.fromAbbrev("4D"), Card.fromAbbrev("5D"),
                    Card.fromAbbrev("6D"), Card.fromAbbrev("7D")
            });
    ...
    void compareTo() {
        ...
        assertTrue(stra5.compareTo(str26) < 0, "Straight ending in 5 should lose to Straight ending in 6");
        // str26 (top 6) < strta (top K)
        assertTrue(str26.compareTo(strta) < 0, "Straight ending in 6 should lose to Broadway (ending in K)");
